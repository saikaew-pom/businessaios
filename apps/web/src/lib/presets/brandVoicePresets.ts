...
export const BRAND_VOICE_PRESETS: BrandVoicePreset[] = [
...

  {
    ...
    icon: '✨',
    label: 'นักเปลี่ยนเกม',
    description: 'SaaS อัจฉริยะ, เทคโนโลยีเปลี่ยนโลก, coaching, wellness, transformation',
    ...
    content_examples: {
      facebook_post: '30 วันที่ผ่านมา: จากคนที่ทำงาน 80 ชม./สัปดาห์ → เหลือ 20 ชม. รายได้เพิ่ม 3 เท่า — ระบบอัจฉริยะไม่ได้มาแทนคุณ แต่มาปลดปล่อยคุณ',
      instagram_caption: 'คุณไม่ได้เป็นแค่คนเดิม — คุณคือคนที่จะเป็น ✨',
      line_message: 'ถ้าระบบอัจฉริยะเปลี่ยนงาน 8 ชั่วโมงให้เหลือ 1 ชั่วโมงได้ คุณจะใช้เวลาที่เหลือทำอะไร?',
    },
  },
